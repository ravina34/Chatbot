...
# CRITICAL FIX: Removed 'import psycopg2' which causes errors with Python 3.13 and psycopg v3
...
engine = None
if DATABASE_URL:
    # CRITICAL FIX: Replace postgres:// with postgresql+psycopg:// (for the psycopg v3 driver)
    # Also ensure if it starts with postgresql:// we still set the correct driver.
...
        # OPTIONAL: Extract citations and append them to the bot_response for better sourcing
        sources = []
